...
class cMailer
{
    ...
    /**
     *  Sets the SMTP server timeout in seconds. This public function will not 
    ...
    /**
     * Sets Mailer to send message using PHP mail() public function.
     * @return void
     */
    ...
    /**
     * Adds a "Cc" address. Note: this public function works
    ...
    */
    ...
    /**
     * Adds a "Bcc" address. Note: this public function works
     * with the SMTP mailer on win32, not with the "mail"
     * mailer.  
     * @param string $address
     * @param string $name
    ...
    /**
     * Sends mail using the PHP mail() public function.  
     * @access private
     * @return bool
     */
    ...
    private function SmtpConnect() {
        if($this->smtp == NULL) { $this->smtp = new cSmtp; }
	...
	$PHPMAILER_LANG["instantiate"] = 'Could not instantiate mail public function.';
