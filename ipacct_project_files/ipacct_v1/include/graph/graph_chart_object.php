...
function open_flash_chart_object_str( $width, $height, $url, $use_swfobject=true, $base='include/graph/' )
{
    //
...
function open_flash_chart_object( $width, $height, $url, $use_swfobject=true, $base='include/graph/' )
{
    //
...
function _ofc( $width, $height, $url, $use_swfobject, $base )
{
    ...
    $out[] = 'type="application/x-shockwave-flash" pluginspage="' . $protocol . '://www.macromedia.com/go/getflashplayer" id="'. $obj_id .'" wmode="transparent"></embed>';
    $out[] = '</object>';
