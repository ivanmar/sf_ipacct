...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/sf_ipacct/log/ipacct_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/sf_ipacct/cache/ipacct/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/sf_ipacct/apps/ipacct/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/sf_ipacct/cache/ipacct/dev/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/sf_ipacct/apps/ipacct/template',
)));
